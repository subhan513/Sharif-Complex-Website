...
export default function ProductsPage({ post }) {
  //console.log(post);
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={"https://solnyne.com/products/" + post.slug}
        />
      ...
      <section className="  pb-10 relative px-5">
        ...
        <div className="main-sec container  max-w-5xl  mx-auto space-y-4 mt-10 px-5  bg-gradient-to-b from-white to-transparent rounded-xl py-5  mb-4 border border-slate-200 border-b-0 rounded-b-none pb-10 "
            ...
            <ol role="list" className="flex items-center space-x-2">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <Link
                    href="/products"
                    className="ml-2 text-sm sm:text-base font-medium text-gray-500 hover:text-gray-700"
                  >
                    Products
                  </Link>
                </div>
        ...
        <div
          className="space-y-2  mx-auto mt-8 leading-7"
...
export async function getStaticPaths() {
  ...
  const paths = content.products.map((post) => {
...
export async function getStaticProps({ params }) {
  ...
  const post = content.products.find((post) => post.slug === currentPath) || {
    notfound: true,
  };
  return { props: { post } };
}
