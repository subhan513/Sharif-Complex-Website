...
export default function SolutionPage({ post }) {
  //console.log(post);
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={"https://solnyne.com/solutions/" + post.slug}
        />
...
export async function getStaticPaths() {
  ...
  const paths = solution.posts.map((post) => {
...
export async function getStaticProps({ params }) {
  ...
  const post = solution.posts.find((post) => post.slug === currentPath) || {
    notfound: true,
  };
  return { props: { post } };
}
