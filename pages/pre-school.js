  ...
  return (
    <>
      <Head>
        ...
        <title>Pre School | Spica International School</title>
        <meta
          name="title"
          content="PRE SCHOOL | Spica International School"
        />
        <meta
          name="description"
        ...
        <meta
          ...
          content="https://spica.com.pk/_next/image?url=%2Fimages%2Fspica-logo2.png&w=256&q=75"
        />
        <link rel="canonical" href="https://spica.com.pk/pre-school" />
        <link rel="preconnect" href="//www.google-analytics.com" as="script" />
        <meta name="google" content="notranslate" />
      </Head>

      <MainHeader
        pageHeading="PRE SCHOOL"
      ...
      <section className="main-sec">
        ...
        >
          <p>
            <span className="font-bold">Spica International School</span> Gujranwala Campus, commenced in March 2023, is a highly celebrated addition to the Gujranwala City. With modern facilities and Early Years Curriculum, state of the art Conference Hall, well equipped labs, spacious playing field, and air conditioned classrooms. Spica International School is one of the largest Pre- School in vicinity of Hafizabad Road Gujranwala. Tablets, interactive smart boards, smart televisions and multimedia are provided for e-learning opportunities to the students at school.
          </p>
          <p>
            <ul>
          Class levels in Pre- School:
          <li>• Playgroup​</li>
          <li>• Nursery</li>
          <li>• Prep\Kindergarten</li>
          </ul>
          </p>
          <p>It is our aim to develop young inquirers who contribute towards a safe world with better understanding of rights and duties of all. This helps them become global citizens in the 21st Century.</p>
          <p>Age appropriate playground equipment enables them to develop their body balance and motor skills in a safe environment. A colourful learning environment gives a new vigor to the young minds to flourish better and explore more!</p>
          <p>Latest teaching and learning approaches are planned by Early Years staff trained to introduce the concepts of Literacy, Numeracy and General Knowledge.</p>
        </div>
      </section>
