...
export default function Nav() {
  ...
  const admissionLinks = [
    { name: "Admission Policy", path: "/admissionpolicy" },
    { name: "Classes", path: "/classes" },
    { name: "Scholarships", path: "/scholarships" },
    { name: "How to Apply", path: "/howtoapply" },
    { name: "Examination System", path: "/examinationsystem" },
  ];

  const aboutLinks = [
    { name: "Principal Message", path: "/principalmessage" },
      ...
      <div className="flex items-center w-full justify-between">
        ...
        <ul className="hidden xl:flex space-x-6 uppercase font-semibold transition-all">
          ...
          <li className="relative" onMouseEnter={() => setOpenDropdown("admission")} onMouseLeave={() => setOpenDropdown(null)}>
            <span className="hover:text-red-500 cursor-pointer">Admission</span>
            <AnimatePresence>
          ...
          <li><Link href="/blog" className="hover:text-red-500 transition">Career</Link></li>
...
//     }, 300); // 300ms ka delay taake user dusray links tak smoothly move kar sake
//   };
//   const handleClick = (menu, path) => {
//     setOpenDropdown(menu); // Dropdown khol do
//     router.push(path); // Page change karo
//   };
...
//   return (
//     <>
//       <nav className=" w-full  bg-transparent  bg-opacity-30 transition-all duration-500 h-24 px-10 sm:px-10 flex items-center xl:justify-between justify-start absolute  z-50 group">
//         <div className="flex">
//           <button
//             type="button"
...
//               className="backHome sm:w-48 w-10 h-30 cursor-pointer pt-1 mt-28 w"
//               width={120}
//               height={50}
...
//           >
//             <span className="hover:text-gray-300 cursor-pointer">Admission</span>
//             {openDropdown === "admission" && (
//               <motion.ul
...
//                 className="absolute left-0 mt-2 w-48 bg-white text-gray-900 shadow-lg rounded-lg overflow-hidden"
//               >
//                 {admissionLinks.map((item, index) => (
//                   <li key={index} className="hover:bg-gray-200 px-4 py-2">
//                     <Link href={item.path} className="block">{item.name}</Link>
//                   </li>
//                 ))}
//               </motion.ul>
//             )}
